            ...
            <ul className=" uppercase font-bold">
              <li className=" float-right m-4">
                ...
                <button
                  ...
                  className=" transition-all duration-300 border-2 bg-blue-600 hover:bg-white text-white hover:text-black h-10 rounded-sm w-20"
                >
                  Login{" "}
                </button>{" "}
              </li>
              <li className=" float-right m-4">
                ...
                <button
                  ...
                  className=" transition-all duration-300 border-2 bg-white hover:bg-blue-600 text-black hover:text-white h-10 rounded-sm w-20"
                >
                  Sign{" "}
                </button>{" "}
              </li>
