    ...
    <div>
      <div className=" bg-gray-300 flex flex-col items-center w-full mt-20 md:mt-36 py-12">
        <div className="  h-12 flex flex-row text-xl justify-center gap-1 md:gap-7 cursor-pointer">
          <div className=" bg-white h-10 w-10 flex items-center justify-center rounded-full border-2 hover:text-blue-600 hover:border-blue-600">
            <FaCircle />
          </div>
          <div className=" bg-white h-10 w-10 flex items-center justify-center rounded-full border-2 hover:text-blue-600 hover:border-blue-600">
            <AiFillTwitterCircle />
          ...
          <div className=" md:w-1/3  h-32 text-center">
            ...
            <ul>
              <ul className=" text-xl">
                ...
                <li className=" text-black hover:text-opacity-60">
                  Testimonials
                </li>
