    ...
    <div>
      <div className="footer bg-stone-300 flex flex-col items-center w-full mt-20 md:mt-36 py-12">
        <div className="  h-12 flex flex-row text-xl justify-center gap-1 md:gap-7 cursor-pointer">
          <div className=" bg-white text-sky-800 h-10 w-10 flex items-center justify-center rounded-full border-2 hover:text-blue-600 hover:border-blue-600">
            <FaCircle />
          </div>
          <div className=" bg-white text-sky-800 h-10 w-10 flex items-center justify-center rounded-full border-2 hover:text-blue-600 hover:border-blue-600">
            <AiFillTwitterCircle />
        ...
        <div className=" flex flex-col w-10/12 md:flex-row gap-4 mt-4 ">
          <div className=" md:w-1/3  h-32 text-center md:text-left">
            ...
            <span>
              Nanoquest was fouded on 2012, now we have branches all over India.
        ...
        <div className=" w-full text-center font-semibold mt-12">
          © Copyrights. All rights reserved.Nanoquest
        </div>
      </div>
    </div>
  );
