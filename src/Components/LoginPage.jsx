  ...
  return (
    <div className=" fixed flex bg-transparent items-center justify-center w-full mt-20 h-auto  px-32  md:py-20 ">
      <div className="login_form text-xl   mt-20 left-1/2 top-24 md:top-36 ">
        <span className="flex justify-end text-3xl p-4">
          {" "}
          <IoMdClose onClick={loginClicked} />
        </span>
        <div className="p-10">
          ...
          <form onSubmit={loginClicked}>
            ...
            <button
              ...
              className=" w-20 md:w-24 md:p-2 mt-4 bg-blue-600 border-2 hover:text-white rounded-md"
            >
              Login
            </button>
            <button
              type="button"
              onClick={handleClear}
              className=" w-20  md:w-24 md:p-2 ml-4 rounded-md border-2 hover:text-white bg-blue-600"
            >
              Clear
            </button>
          </form>
