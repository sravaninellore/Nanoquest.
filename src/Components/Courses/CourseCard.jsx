...
function CourseCard({data,img,CourseTitle, courseClicked}) {
  return (
    ...
    <>
      ...
      <div className='p-2  justify-evenly gap-2 py-14 md:px-16 flex flex-row flex-wrap md:gap-12'>
         ...
         { data.map((item,key)=>(
          <div onClick={courseClicked} className=' bg-stone-200 shadow-xl w-36 md:w-56  h-auto md:h-auto 
           transition-all duration-300 hover:scale-105  flex flex-col items-center p-1 md:p-2 cursor-pointer'>
