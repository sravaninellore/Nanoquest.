    ...
    <>
      <div className="w-full  flex-col justify-center items-center py-32">
        ...
        <div className="p-2  justify-evenly gap-2 py-14 md:px-16 flex flex-row flex-wrap md:gap-12">
          {data.map((item, key) => (
            <div className=" bg-gradient-to-r from-blue-300 to-blue-500 w-36 md:w-56  h-auto md:h-auto flex flex-col items-center p-1 md:p-2">
              <img src={img} alt="courcePic" />
              <h1 className=" text-left font-semibold text-lg md:text-xl">
                {item.course}
              </h1>
