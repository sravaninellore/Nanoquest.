  ...
  return (
    <div className=" fixed flex bg-transparent items-center justify-center w-full mt-20 h-auto p-4 px-20">
      <div className="signup_form text-xl  mt-12 left-1/2 top-16 md:top-24 ">
        <span className="flex justify-end text-xl md:text-3xl p-4">
          {" "}
          <IoMdClose onClick={signupClicked} />
        </span>
        <div className="p-10">
          ...
          <form onSubmit={signupClicked}>
            <div>
              ...
              <div className="flex flex-col">
                ...
                <input
                  type="text"
                  className="px-4 ml-4 mt-2 w-44 md:w-60 text-black"
                />
              </div>
            </div>
            <br />
            ...
            <span className=" flex flex-row m-4">
              <button
                ...
                className=" w-24  bg-blue-600 border-2 hover:text-white rounded-md md:p-2"
              >
                Login
              </button>
              <button
                type="button"
                onClick={handleClear}
                className=" w-24  md:p-2 ml-4 rounded-md border-2 hover:text-white bg-blue-600"
              >
                Clear
              </button>
            </span>
